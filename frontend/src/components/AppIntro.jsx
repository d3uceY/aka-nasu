...
// The opening signature moment: the brand lockup and the tomato arrive at the
// centre of the screen, the wordmark departs, then the tomato carries the
// attention from the middle of the screen to its resting seat in the app.
// Choreography — nothing appears at once, every move answers "why does it move?".
export function AppIntro() {
  const rootRef = useRef(null)
  const tomatoRef = useRef(null)

  const dial = useDialRotation()
  // The intro tomato is a showcase — never draggable.
  ...
  useGSAP(
    () => {
      ...
      // Reduced motion: no tomato, no flight — a quick, calm fade out. This
      ...
      tl.from('.intro__mark', { scale: 0, rotation: -140, autoAlpha: 0, duration: 1.0, ease: 'back.out(1.6)' }, 0.1)
        ...
        // The wordmark departs tastefully — floats up, softens into blur.
        ...
        // The room fades in beneath; the tomato hands off seamlessly.
  ...
  return (
    <div className="intro" ref={rootRef} aria-hidden="true">
      ...
      <div className="intro__center">
        ...
        <div className="intro__tomato" ref={tomatoRef} style={{ '--intro-size': `${size}px` }}>
